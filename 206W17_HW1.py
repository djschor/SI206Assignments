...
def name_counts(names):
    ...
    sort2 = sorted(sorted_items, key = lambda x: x[0])
    return sort2
...
## Given the list ["thank","goodness","it's","friday"],l the function should return "TGIF".
...
class House(object):
    ...
    def determine_size(self):
        if self.house_color == 'blue': 
            ...
            self.house_size = 'small'
        else:
            self.house_size = 'medium'
        return self.house_size
